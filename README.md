...
02 성격          당당한 / 차분한 / 다정한 / 발랄한. 화면 폭을 채운 네 줄
03 특성          빨간 면 위의 큰 견본 + 크기·무게·빠르기 연속 슬라이더
04 한 줄         60자. 중앙 기본 정렬 / 정렬 순환 / 기울기 토글
                 60자를 채우면 화면이 물러서며 가장자리에서 파동이 번진다.
                 화면을 누르면 다시 들어온다
...
**단계 표시(`1 / 5 · 성격`과 진행 막대)는 없다.** 2026-09-15 스케치가 다섯
화면에서 전부 빼고 있어 걷어냈다. 뒤로 가는 화살표만 남는다.
