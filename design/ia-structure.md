...
관객이라는 세 번째 청중은 없다. 지나가다 외벽을 읽는 사람은 앱을 열지 않는다 —
읽는 자리는 외벽이지 화면이 아니다. (아카이브를 없앤 이유이기도 하다.)
...
| `/wall` | 외벽 출력 | 설치 | 3트랙 풍경 + 트리거 시 10초 강조 |
...
flowchart TD
    ...
    ONWALL["07 외벽에 떠 있음<br/>10초 카운트다운"]
