...
/**
 * 짧은 글(두 줄까지)의 최소 지름. 시안에서 벽 가로폭의 ¼(320px)을 28px 글자로
 * 봤으니 11.4u다. 화면이 아니라 글자에 매단다 — 잔상(22vh)과 강조(72vh)가
 * 배율 하나로 포개지려면 모든 치수가 u의 배수여야 한다.
 */
export const B_MIN_DIAMETER = 11.4;
