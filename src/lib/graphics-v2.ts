...
export const graphics: string[] = [
  ...
  `<svg viewBox="0 0 380 260" preserveAspectRatio="xMidYMid slice" style="opacity:0.7">
    <g style="animation: mfOBreath 7s ease-in-out infinite; transform-origin: 190px 130px">
      <circle cx="190" cy="130" r="115" fill="none" stroke="currentColor" stroke-width="16"/>
      <circle cx="190" cy="130" r="115" fill="none" stroke="currentColor" stroke-width="3" stroke-dasharray="2,12" style="animation: mfORot 24s linear infinite; transform-origin: 190px 130px"/>
    </g>
  </svg>`,

  // === ㄱ — 모서리 (corner of the wall) — bold L-shape, occasional 90° rotation
  `<svg viewBox="0 0 380 260" preserveAspectRatio="xMidYMid slice" style="opacity:0.7">
    <g style="animation: mfGQuarter 12s steps(1) infinite; transform-origin: 190px 130px">
  ...
  `<svg viewBox="0 0 380 260" preserveAspectRatio="xMidYMid slice" style="opacity:0.7">
    <g fill="none" stroke="currentColor" stroke-width="14" stroke-linecap="square" stroke-linejoin="miter">
      <path d="M 30 220 L 110 50 L 190 220" style="animation: mfSRise 5.5s ease-in-out infinite"/>
      <path d="M 150 220 L 230 90 L 310 220" style="animation: mfSRise 5.5s ease-in-out -1.8s infinite"/>
      <path d="M 260 220 L 340 130 L 420 220" style="animation: mfSRise 5.5s ease-in-out -3.5s infinite"/>
    </g>
  </svg>`,

  // === ─ — 단선 (lines / wall grid) — 3 thick horizontal bars with offset registration jitter
  `<svg viewBox="0 0 380 260" preserveAspectRatio="xMidYMid slice" style="opacity:0.7">
    <g style="animation: mfLineDrift 9s ease-in-out infinite">
      <rect x="0" y="60" width="380" height="14" fill="currentColor"/>
      <rect x="0" y="128" width="380" height="14" fill="currentColor" style="animation: mfLineJitter 3.1s ease-in-out infinite"/>
  ...
  `<svg viewBox="0 0 380 260" preserveAspectRatio="xMidYMid slice" style="opacity:0.7">
    <g stroke="currentColor" stroke-width="18" stroke-linecap="square" style="animation: mfAsterRot 18s linear infinite; transform-origin: 190px 130px">
